...
Public Class Registration
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        con.ConnectionString = "Data Source=(LocalDB)\v11.0;AttachDbFilename=C:\Users\ACER\Documents\Visual Studio 2013\Projects\hotel\hotel\Students.mdf;Integrated Security=True"
        con.Open()
        cmd.Connection = con
